...
int main(int argc, const char *argv[])
{
    ...
    vector<double> lidar_ttc, camera_ttc;
    std::ofstream outfile;
    outfile.open("../TTC.txt", std::ios_base::app);
    // data location
    string dataPath = "../";
    ...
    string descriptorFamily = "DES_HOG"; // DES_BINARY, DES_HOG
    string selectorType = "SEL_KNN";         // SEL_NN, SEL_KNN
    
    outfile << "Detector Type: " << detectorType << " ";
    outfile << "Descriptor Type: " << descriptorType << " ";
    outfile << "Matcher Type: " << matcherType << " ";
    outfile << "Descriptor Family: " << descriptorFamily << " ";
    outfile << "Selector Type: " << selectorType << "\n";
    ...
    outfile << "lidar outputs: ";

    for (auto i : lidar_ttc)
    {
        outfile << i << " ";
    }
    outfile << "\n";

    outfile << "camera outputs: ";

    for (auto i : camera_ttc)
    {
        outfile << i << " ";
    }
    outfile << "\n\n";
